function limpiar_formulario(){
		...
		var campoTextoCategoryId = document.getElementById("category_Id");
...
function consultar_todo(){
    $.ajax({ 
        url:"https://g4a3dd87471a67b-bdreto1.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/cabin/cabin",
        type:"GET",
        datatype:"json",
        ...
        success:function(json){
           	$("#resultado").empty();
			tabla = "<center> <table border='1'> <tr> <th>ID</th> <th>BRAND</th> <th>ROOMS</th> <th>CATEGORY_ID</th><th>NAME</th></tr> </tr>"
...
function consultaID(id){
	...
	if(!validarCampo($("#id"))){
		...
		$.ajax({
			url: 'https://g4a3dd87471a67b-bdreto1.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/cabin/cabin'+ id.val(),			
			type: 'GET',
			dataType: 'json',
...
function guardarInformacion(){
	...
	if(!validarCampo($("#categoryId"))){
		alert("Debe ingresar una category_ID");
		return;
	}
