...
function consultar_todo(){
    $.ajax({
        url:"https://g4a3dd87471a67b-bdreto1.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/message/message",
		type:"GET",
        datatype:"json",
...
function consultaID(id){
	...
	if(!validarCampo($("#id"))){
		...
		$.ajax({
			url: 'https://g4a3dd87471a67b-bdreto1.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/message/message'+ id.val(),			
			type: 'GET',
			dataType: 'json',
